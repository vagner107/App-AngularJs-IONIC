...
/***********************************************************************************
* Controller : AppCtrl chamado na index
* statesService : servico
***********************************************************************************/
.controller('AppCtrl', function($scope, $ionicPlatform, $cordovaLocalNotification, $state, $ionicPopup, AuthService, AUTH_EVENTS) {



	$ionicPlatform.ready(function(){
		$cordovaLocalNotification.add({ message: 'Hello teste' });
	});	
...
* statesService : servico
***********************************************************************************/
.controller('WelcomeCtrl', function($scope, $ionicModal, $timeout, $state, $ionicLoading, $ionicPopup, $http, $httpBackend, statesService, AuthService, AUTH_EVENTS, $rootScope, $ionicUser, $ionicPush) {
